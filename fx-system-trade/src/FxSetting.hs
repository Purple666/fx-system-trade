...
getTradeHoldTime fsd =
  ...
  in if Fsd.trTrade ls == 0
     then 0
     else truncate $ logBase 1.01 ((fromIntegral $ getSimChartMax fsd) * (fromIntegral $ Fsd.trTradeDate ls `div` Fsd.trTrade ls)) * getLearningTestTimes fsd
