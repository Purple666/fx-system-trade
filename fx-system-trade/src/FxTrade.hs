...
evaluationOk tdl tdlt =
  0 < Ftd.getEvaluationValue tdl && (and $ map (\x -> 0 < Ftd.getEvaluationValue x) tdlt) -- 0 < Ftd.profit tdl && 0 < getProfitList tdlt && 
...
getQuantityLearning td chart = Gsd.initalProperty Gsd.gsd -- Ftd.realizedPL td
