...
getEvaluationValue fsd td =
  ...
  then - (Fsd.getLogProfit fsd * Ftd.realizedPL td * Ftd.profit td * Ftd.getWinRatePure td) / (fromIntegral $ Ftd.chartLength td)
  else   (Fsd.getLogProfit fsd * Ftd.realizedPL td * Ftd.profit td * Ftd.getWinRatePure td) / (fromIntegral $ Ftd.chartLength td)
{-  
