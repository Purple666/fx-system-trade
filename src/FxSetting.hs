...
createRandomFxAlgorithmSetting andRate ix = do
  ...
  at <- Tr.makeTree taAndR taOrR (Fad.algorithmListCount ix) Tr.Empty -- (Fad.algorithmTree ix)
...
createRandomFxTechnicalAnalysisSetting andRate ix = do
  ...
  tat <- Tr.makeTree taAndR taOrR (Fad.techListCount ix) Tr.Empty -- (Fad.techAnaTree ix)
